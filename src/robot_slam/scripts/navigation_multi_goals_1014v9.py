...
rotate_time1 = 3.3   #刚开始的强制旋转1
rotate_time2 = 3.1   #刚开始的强制旋转2，现在弃用该方案
rotate_time3 = 3.2   #中间的强制旋转3

end_y7_v = 0.3       #现在7点这组参数和8点要一样
end_y7_time = 1.5
end_x7_v = 0.2
end_x7_time = 0.6
    ...
    if (input == '1'):
        ...
        while(position_end == 0):
            if(find_id == 1):
                ...
                #rospy.sleep(0.5)
                #move_rotate_180(rotate_time2) #刚开始的强制旋转2
                navi.goto(goals[0])
            ...
            if(find_id == 5 ):#or (rospy.Time.now()-start_time > duration and nowtimeflag == 1)):
                ...
                navi.goto(goalzhongzhuan[0])
                move_rotate_180(rotate_time3)  #中间的强制旋转3
