...
class navigation_demo():
    ...
    def ar_cb(self, data):
        ...
        #point_msg = None
            ...
            print(find_id)
        #point_msg = None
        elif (point_msg.z>=111 and point_msg.z<=120):
            find_id = 6
            #print(find_id)
        #point_msg = None
    ...
    if (input == '1'):
        ...
        while(position_end == 0):
            if(find_id == 1):
                ...
                rospy.sleep(1)
                move_rotate_180(rotate_time2)
                navi.goto(goals[0])
                os.system('mplayer %s' % "~/music/arrive_1.mp3")
                input = raw_input()  #KKKK
            ...
            if(find_id == 7):
                ...
                input = raw_input()  #KKKK
                move2end(0,end_y7_v,end_y7_time)  #KKKK #move2endfory7
                rospy.sleep(0.5)
                move2end(end_x7_v,0,end_x7_time)  #KKKK #move2endforx7
            ...
            if(find_id == 8):
                ...
                #input = raw_input()  #KKKK
                move2end(0,end_y8_v,end_y8_time)  #KKKK #move2endfory8
                rospy.sleep(0.5)
                move2end(end_x8_v,0,end_x8_time)  #KKKK #move2endforx8
                os.system('mplayer %s' % "~/music/arrive_end.mp3")
                find_id = 0
                position_end = 1
            else :
